...
class Net_CDDB_Protocol_Mdb2 extends Net_CDDB_Protocol
{
     ...
     * @return void
     */
    protected function _cddbQuery($cmd, $query)
    {
     ...
     * @return void
     */
    protected function _cddbLscat($cmd, $query)
    {
     ...
     * @return void
     */
    protected function _cddbRead($cmd, $query)
    {
        /*
     ...
     * @return void
     */
    protected function _motd($cmd, $query)
    {
        /*
     ...
     * @return void
     */
    protected function _ver($cmd, $query)
    {
        $this->_status_buffer = NET_CDDB_RESPONSE_OK;
     ...
     * @return void
     */
    protected function _stat($cmd, $query)
    {
        $entry_counts = array();
        $total = 0;
